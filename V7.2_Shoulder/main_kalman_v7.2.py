...
def video():
    ...
    y3=[]
    y4=[]
    cap = cv2.VideoCapture('/Users/stella/Desktop/Meidapipe/Mediapipe.mp4')  # D:cut_1.mp4, /Users/stella/Desktop/Meidapipe/cut_1.mp4
...
# TODO: exit
    ...
    diff.legend()
    plt.savefig('./shoulder_with_reset_Modul_2_0.028.jpg')
    plt.show()
    plt.close()

    # fig, diff1 = plt.subplots()
    # diff1.plot(x, y3, label='x_change', color='coral')
    # diff1.plot(x, y4, label='y_change', color='green')
    # diff1.set_title('y')
    # diff1.set_xlabel('ts')
    # diff1.set_ylabel('Distance')
    # diff1.legend()
    # plt.savefig('chang_x_y.jpg')
    # plt.show()
