...
def video():
    ...
    all_kalman = set_kalman_Points.set_kalman_all()

    up_kalman = set_kalman_Points.set_kalman_hand()
    down_kalman = set_kalman_Points.set_kalman_hand()
...
# TODO: show all new points.
            ...
            # current_prediction, last_wrist, accesspoints_up, accesspoints_down, change_up, change_down
            hand_prediction, last_wrist, accesspoints_up, accesspoints_down, change_up, change_down = \
                kalman_hand.hand_points(up_kalman, down_kalman, landmarks, last_wrist, accesspoints_up,
                                        accesspoints_down, change_up, change_down)
