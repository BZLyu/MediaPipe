...
#             todo: Absolute error
            ...
            str_ab_k_average = "Absolute Error Kalman on average" + str(int(sum_erro_k/(Total*8)))
            str_ab_m_average = "Absolute Error Mediapip on average" + str(int(sum_erro_m/(Total*8)))
