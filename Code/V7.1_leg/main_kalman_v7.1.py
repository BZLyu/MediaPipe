...
# TODO: show real Points.
            ...
            if frame_pointer >=25576 and frame_pointer <=26076:
                ...
                d_m = mediapipe_list[0][0] - real_list[0][0]
                d_k = kalman_list[0][0] - real_list[0][0]
...
# TODO: exit
    ...
    diff.set_title('diff_left_leg_with_reset')
    diff.set_xlabel('ts')
    diff.set_ylabel('diff')
    diff.legend()
    plt.savefig('./diff_left_leg_with_reset_frist10.jpg')
    plt.show()
    plt.close()
    ...
    diff1.set_title('diff_left_leg_with_reset')
    diff1.set_xlabel('ts')
    diff1.set_ylabel('diff')
    diff1.legend()
    plt.savefig('./diff_left_leg_with_reset1_frist10.jpg')
    plt.show()
