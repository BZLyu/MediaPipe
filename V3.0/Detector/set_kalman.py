...
def set_kalman_all():
    ...
    t = 1
    c = 0.075  # Change of acceleration
    n_diff = 4  # Number of derivation

    # TODO: Set unit D for calculating F
...
def kalmanfilter(num_state, num_point, num_dimension, unit_num_state, n_diff, d, t, c):
    ...
    # TODO: Set process NoiseCov Q
    # q = get_q(unif, num_point, c)
    # kalman.Q = np.array(q)
    kalman.Q = Q_discrete_white_noise(n_diff, t, c, num_point * num_dimension, False)
    # TODO: Set deterministic Noise B
    kalman.B = 0
